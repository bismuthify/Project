...
\]
  ...
  \begin{frame}{Bifurcation Diagram}
   ...
   \centering \includegraphics[width=0.7\linewidth]{{images/detNNR017m0.2}.pdf}
   \end{frame}
   ...
   \centering \includegraphics[width=0.7\linewidth]{{images/detNNR017m0.01}.pdf}
   \end{frame}
   ...
   \centering \includegraphics[width=0.7\linewidth]{{images/GillECR017m0.2}.pdf}
   \end{frame}
   
   \begin{frame}{Stochastic: Adaptive Tau Algorthim}
   Equal Coupling, Population of 500000, $\mathcal{R}_0=18.69$, $m=0.2$
   \centering \includegraphics[width=0.7\linewidth]{{images/adaptauECR018.6869m0.2}.pdf}
   \end{frame}
