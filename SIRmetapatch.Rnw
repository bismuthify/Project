...
par(mgp = c(2, 0.6, 0))
 for(ind in 1:length(submlistInd)){
   ...
   if (ind ==3){
          plot(R_0list, avgCoherence[submlistInd[ind],],type='l',col=ind, ylim=c(yminval,ymaxval))}
         #axis(1, col = "grey40", col.axis = "grey20")}
   if (ind ==1){
          plot(R_0list, avgCoherence[submlistInd[ind],],type='l',col=ind, ylim=c(yminval,ymaxval),xaxt='n')}
         #axis(1, col = "grey40", col.axis = "grey20")}
     if (ind ==2){
          plot(R_0list, avgCoherence[submlistInd[ind],],type='l',col=ind, ylim=c(yminval,ymaxval),xaxt='n',yaxt='n')}
   if (ind ==4){
          plot(R_0list, avgCoherence[submlistInd[ind],],type='l',col=ind, ylim=c(yminval,ymaxval),yaxt='n')}
